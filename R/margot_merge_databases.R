...
#' This function is deprecated. Please use `boilerplate::boilerplate_merge_databases()` instead.
...
#' # library(boilerplate)
#' # boilerplate::boilerplate_merge_databases(...)
#' }
#'
#' @import lifecycle
#' @import cli
#'
#' @export
margot_merge_databases <- function(...) {
  lifecycle::deprecate_warn(
    when = "0.2.1.23",
    what = "margot_merge_databases()",
    with = "boilerplate::boilerplate_merge_databases()"
  )

  cli::cli_alert_warning("This function is deprecated. Please use boilerplate::boilerplate_merge_databases() instead.")
  ...
  cli::cli_alert_info("Note: The new function name uses the plural 'databases'.")
}
