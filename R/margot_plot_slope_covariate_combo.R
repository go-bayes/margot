...
margot_plot_slope_covariate_combo <- function(data,
  ...
  if (!is.null(save_path)) {
    ...
    margot::here_save(combined_plot, filename, dir_path = save_path)
    cli::cli_alert_success("Combined plot saved successfully as {filename}.png and {filename}.rds \U0001F44D")
  }
