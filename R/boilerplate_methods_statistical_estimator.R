...
#' # library(boilerplate)
#' # boilerplate::boilerplate_report_statistical_estimator(...)
#' }
#'
#' @import lifecycle
#' @import cli
#'
#' @export
boilerplate_methods_statistical_estimator <- function(...) {
  lifecycle::deprecate_warn(
    when = "0.2.1.23",
    what = "boilerplate_methods_statistical_estimator()",
    with = "boilerplate::boilerplate_report_statistical_estimator()"
  )

  cli::cli_alert_warning("This function is deprecated. Please use boilerplate::boilerplate_report_statistical_estimator() instead.")
