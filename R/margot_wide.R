...
#'
#' @section Deprecated:
#' This function was soft-deprecated in version 1.0.38 and will be removed in a future release.
#'
#' @param .data A data frame containing the longitudinal data in long format.
#' @param baseline_vars A character vector of baseline variable names to include.
#' @param exposure_var A character vector of exposure variable names.
...
margot_wide <- function(.data,
  ...
  lifecycle::deprecate_soft(
    when = "1.0.0",
    what = "margot::margot_wide()",
    with = "margot::margot_wide_machine()"
  )

  # …original margot_wide body here…
}
