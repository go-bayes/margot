...
#' @param dpi The resolution in dots per inch for saved plots. Default is 600.
#' @param width The width of the saved plots in inches. Default is 12.
#' @param height The height of the saved plots in inches. Default is 12.
#' @param save_plots Logical; if TRUE, plots will be saved to disk. Default is TRUE.
#' @param output_dir The directory where plots should be saved. Default is "push_mods".
#' @param spend A numeric value between 0 and 1 specifying the spend level for difference gain calculations. Default is 0.2.
#'
