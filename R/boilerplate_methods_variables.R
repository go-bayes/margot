...
#'
#' @keywords internal
boilerplate_methods_variables <- function(...) {
  lifecycle::deprecate_warn(
    when = "0.2.1.23",
    what = "boilerplate_methods_variables()",
    with = "boilerplate::boilerplate_report_variables()"
  )

  cli::cli_alert_warning("This function is deprecated. Please use boilerplate::boilerplate_report_variables() instead.")
...
#' #'
#' #' @export
#' boilerplate_methods_variables <- function(exposure_var, outcome_vars, measure_data, appendices_measures = NULL, ...) {
