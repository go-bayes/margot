test_that("margot_compute_ipsi_probability reproduces IPSI mechanics", {
  ...
  expect_equal(res$natural_p, rep(round(845 / 28225, 4), 3))
  expect_equal(res$counterfactual_p,
               round(c(0.5149689991, 0.8059875996, 0.9029937998), 4))
  expect_equal(res$fold_increase,
               round(c(17.20118343, 26.92189349, 30.16213018), 1))
...
test_that("margot_compute_ipsi_probability accepts knitr_kable tables", {
  ...
  expect_equal(res$counterfactual_p, round(1 - (1 - 355 / 16986) / 2, 4))
})
