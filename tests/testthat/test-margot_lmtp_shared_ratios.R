# The fixtures used here live in helper-lmtp-shared.R so the task-parallel tests
# exercise exactly the same deterministic frame, shift, settings, and numerics.
