...
- [`create_ordered_variable()`](https://go-bayes.github.io/margot/reference/create_ordered_variable.md)
  : Create Ordered Variable Based on Quantile Breaks or Custom Breaks
  with Informative Labels
- [`impute_and_combine()`](https://go-bayes.github.io/margot/reference/impute_and_combine.md)
  : Perform multiple imputation on a list of data frames and combine the
  results
- [`margot_adjust_weights()`](https://go-bayes.github.io/margot/reference/margot_adjust_weights.md)
  : Adjust Weights for Censoring and Sample Design with Progress
  Reporting
- [`margot_censor()`](https://go-bayes.github.io/margot/reference/margot_censor.md)
  : Transform year_measured Variable Based on Clustered Conditions
  Within Waves
- [`margot_censor_lead()`](https://go-bayes.github.io/margot/reference/margot_censor_lead.md)
...
- [`margot_filter()`](https://go-bayes.github.io/margot/reference/margot_filter.md)
...
- [`margot_process_binary_vars()`](https://go-bayes.github.io/margot/reference/margot_process_binary_vars.md)
...
- [`margot_process_longitudinal_data_wider()`](https://go-bayes.github.io/margot/reference/margot_process_longitudinal_data_wider.md)
  : Process longitudinal dyadic data in wide format with censoring by
  missing exposure and silent dummy-coding
- [`margot_wide_machine()`](https://go-bayes.github.io/margot/reference/margot_wide_machine.md)
  : Transform longitudinal data to wide format with baseline imputation
  and optional NA indicators
...
- [`margot_rate_batch()`](https://go-bayes.github.io/margot/reference/margot_rate_batch.md)
  : Batch-compute RATEs for each outcome in a margot_causal_forest
  result
...
- [`margot_lmtp_combine_and_contrast()`](https://go-bayes.github.io/margot/reference/margot_lmtp_combine_and_contrast.md)
  : Combine LMTP Models from Multiple Batches and Compute Cross-Batch
  Contrasts
...
- [`margot_policy_tree_evaluate()`](https://go-bayes.github.io/margot/reference/margot_policy_tree_evaluate.md)
  : Learn a benefit-threshold rule and evaluate it on separate supplied
  scores
...
- [`print(`*`<margot_correlation_assessment>`*`)`](https://go-bayes.github.io/margot/reference/print.margot_correlation_assessment.md)
...
- [`margot_correct_combined_table()`](https://go-bayes.github.io/margot/reference/margot_correct_combined_table.md)
  : Correct a "combined table" for multiplicity \*\*and\*\* recompute
  \*E\*-values
...
- [`margot_lmtp_evalue()`](https://go-bayes.github.io/margot/reference/margot_lmtp_evalue.md)
...
- [`margot_model_evalue()`](https://go-bayes.github.io/margot/reference/margot_model_evalue.md)
  : Combine Model Summary and E-Value Calculation for Various Causal
  Models
...
- [`margot_summary_cate_difference_gain()`](https://go-bayes.github.io/margot/reference/margot_summary_cate_difference_gain.md)
  : Compute Difference in Gains and Integrated Difference Between
...
- [`margot_plot_qini_cost_sensitivity()`](https://go-bayes.github.io/margot/reference/margot_plot_qini_cost_sensitivity.md)
  : Plot QINI Curves Across Treatment Cost Scenarios
- [`margot_plot_qini_cost_summary()`](https://go-bayes.github.io/margot/reference/margot_plot_qini_cost_summary.md)
...
- [`margot_plot_histogram()`](https://go-bayes.github.io/margot/reference/margot_plot_histogram.md)
  : Create a Histogram with Mean and Standard Deviation Highlights for
  Each Wave and Variable
...
- [`df_margot_example`](https://go-bayes.github.io/margot/reference/df_margot_example.md)
...
- [`margot_simulate_test_data_flip()`](https://go-bayes.github.io/margot/reference/margot_simulate_test_data_flip.md)
...
- [`margot_propensity_model_and_plots()`](https://go-bayes.github.io/margot/reference/margot_propensity_model_and_plots.md)
  : Create Propensity Score Model and Associated Plots
- [`back_transform_logmean()`](https://go-bayes.github.io/margot/reference/back_transform_logmean.md)
...
- [`back_transform_zscore()`](https://go-bayes.github.io/margot/reference/back_transform_zscore.md)
...
- [`margot_back_transform_log_z()`](https://go-bayes.github.io/margot/reference/margot_back_transform_log_z.md)
  : Create Z-score to Original Scale Mapping for Log-Transformed Data
- [`margot_debug_qini()`](https://go-bayes.github.io/margot/reference/margot_debug_qini.md)
...
- [`margot_qini_scale_note()`](https://go-bayes.github.io/margot/reference/margot_qini_scale_note.md)
  : Generate Explanatory Note for QINI Scale
- [`margot_qini_scale_subtitle()`](https://go-bayes.github.io/margot/reference/margot_qini_scale_subtitle.md)
...
- [`pretty_number()`](https://go-bayes.github.io/margot/reference/pretty_number.md)
  : Format Numbers with Commas
- [`remove_numeric_attributes()`](https://go-bayes.github.io/margot/reference/remove_numeric_attributes.md)
...
- [`regress_with_covariates()`](https://go-bayes.github.io/margot/reference/regress_with_covariates.md)
  : Generalized Linear Regression with Covariates
- [`select_and_rename_cols()`](https://go-bayes.github.io/margot/reference/select_and_rename_cols.md)
