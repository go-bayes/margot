...
Creates a forest plot visualization of cross-validation heterogeneity
test results from margot_rate_cv(). Shows t-statistics, p-values, and
...
- subtitle:
  ...
  Character string for the plot subtitle. Default shows the adjustment
  method.
...
- remove_model_prefix:
  ...
  Logical; remove "model\_" prefix from model names. Default TRUE.
