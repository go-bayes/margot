...
The lightest option is **Colima** (a tiny Linux VM that the standard
Docker CLI talks to):
...
Verify with `docker info` — you should see a “Server” section listing
“Operating System: Ubuntu …”.

(Docker Desktop also works if you prefer a GUI app.)
